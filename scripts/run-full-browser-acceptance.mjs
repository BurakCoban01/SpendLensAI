...
const env = {
  ...
  SPENDLENS_E2E_NEXT_DIST_DIR: process.env.SPENDLENS_E2E_NEXT_DIST_DIR ?? ".next-e2e-full-browser",
  DATABASE_URL:
...
run("pnpm", ["exec", "playwright", "test", "e2e/full-browser-acceptance.spec.ts"], env);
